...
@Component({
  selector: 'app-headerclinica',
  templateUrl: './headerclinica.component.html',
  styleUrls: ['./headerclinica.component.scss'],
})
export class HeaderclinicaComponent implements OnInit {
