...
@Component({
  selector: 'app-r-v-s-c-ver',
  templateUrl: './r-v-s-c-ver.component.html',
  styleUrls: ['./r-v-s-c-ver.component.scss'],
})
export class RVSCVerComponent implements OnInit {
  ...
  exportToExcel(): void {
    ...
    this.datosVENTA.forEach((data: any) => {
      ...
      const montoCell = excelRow.getCell(7);
    ...
    worksheet.getColumn('H').width = 20; // Ancho de la columna H
